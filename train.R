...
library(keras)
mlflow_start_run()
train_file <- mlflow_param("train", type = "string", default = "~/python_directory/mlflow_presentation/r_mlflow/train.csv")
test_file <- mlflow_param("test", type = "string", default = "~/python_directory/mlflow_presentation/r_mlflow/test.csv")
